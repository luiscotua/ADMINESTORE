...
"""
from django.conf import settings #django jet
import os
...
SECRET_KEY = 'lgum7(&)lm9gn2!*opoj)*onfm+-ls1_zv(4n__t&+7gemj@v8'
...
STATICFILES_DIRS = (
    os.path.join('localstore/static'),
)
